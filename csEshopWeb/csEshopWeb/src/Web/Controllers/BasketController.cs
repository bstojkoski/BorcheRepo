...
namespace Microsoft.eShopWeb.Controllers
{
    ...
    public class BasketController : Controller
    {
        ...
        public async Task<IActionResult> AddToBasket(CatalogItemViewModel productDetails)
        {
            ...
            await _basketService.AddItemToBasket(basketViewModel.Id, productDetails.Id, productDetails.Price, productDetails.Id);
        ...
        {
            var basketViewModel = await GetBasketViewModelAsync();
            await _basketService.SetQuantities(basketViewModel.Id, null);
